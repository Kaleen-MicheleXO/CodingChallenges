...
//Note I solved this 3 times to make it look cleaner
...
function shark(pontoonDistance, sharkDistance, youSpeed, sharkSpeed, dolphin) {
  return pontoonDistance / youSpeed <
    sharkDistance / (dolphin == true ? sharkSpeed / 2 : sharkSpeed)
    ? "Alive!"
    : "Shark Bait!";
}
///////////////////////////////////////////////////////
function shark(pontoonDistance, sharkDistance, youSpeed, sharkSpeed, dolphin) {
  let dol = dolphin == true ? sharkSpeed / 2 : sharkSpeed;
  return pontoonDistance / youSpeed < sharkDistance / dol
    ? "Alive!"
    : "Shark Bait!";
}
